...
To help with the following explanation, imagine there are two types \pcode{Reader[A]} and \pcode{Writer[A]}, and the infamous OOP structure shown in \autoref{code:rw}. (The \emph{dog-people} amongst the readers will forgive.)
...
Kinds \& Type constructors. Higher-kinded types.
