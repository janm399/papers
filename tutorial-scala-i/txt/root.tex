...
def arrayEquatable[A](implicit elementEquatable: Equatable[A]): Equatable[Array[A]] = 
  new Equatable[Array[A]] {
    def ==(lhs: Array[A], rhs: Array[A]) {
      if (lhs.length != rhs.length) false 
      else !lhs.indices.exists(i => lhs(i) != rhs(i))
    }
  }
\end{lstlisting}
