...
\paragraph{Implicits.} Lipsum...

Pimp-my library.


\begin{example}[Exercise: Pimp my library]
Build a DSL that allows the expression evaluator to be written using natural-looking Scala code--though sadly not using the standard \pcode{+, -, *, /} operators, but using our own \pcode{plus, minus, mult, div} instead. 
...
object Expr {
  |Implicit conversions are powerful and potentially very dangerous. Use this import to indicate the|
  |acceptance of this great power and responsibility.|
  import language.implicitConversions

  |Three conversions will be necessary: |Int -> Expr|, |Expr -> RichExpr|, |Int -> RichInt|.|
  implicit class RichInt ...
  implicit class RichExpr ...
  implicit def intToExpr ...
