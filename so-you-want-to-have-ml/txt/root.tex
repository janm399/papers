...
Computation on the smart-watch, mobile, and server-side. Impact on liveliness, cost, etc. Signal fusion, followed by vDSP, Metal \& CoreML. Energy impact, transfer size consideration. 

\section{Server}
Architecture. Ingestion, storage, clustering, model fitting. Hyper-parameter optimisation. Model management.
