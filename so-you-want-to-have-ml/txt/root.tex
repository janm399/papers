...
\fig{model-sequence+location.png}{model-sequence+location}{Exercise sequence model with location context}
...
To provide a useful in-gym workflow, the mobile application uses a sequence of predictors and classifiers.
