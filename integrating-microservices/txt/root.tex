...
\begin{figure*}[h]
  \begin{tikzpicture}
    \draw[pink,   -,fill=pink   ] (0, 0)    rectangle (16, 1.35); \node[draw] at (14.5, 0.7) {heart beat};
    \draw[blue!20,-,fill=blue!20] (0, 1.35) rectangle (16, 2.8);  \node[draw] at (14.5, 0.7) {drink a cup of tea};
    \draw[pink,   -,fill=pink   ] (0, 2.8)  rectangle (16, 4.3);  \node[draw] at (14.5, 0.7) {average commute};
    \draw[blue!20,-,fill=blue!20] (0, 4.3)  rectangle (16, 6);    \node[draw] at (14.5, 0.7) {blockbuster film};
    \draw[pink,   -,fill=pink   ] (0, 6)    rectangle (16, 7.3);  \node[draw] at (14.5, 0.7) {flight between continents};
    \draw[blue!20,-,fill=blue!20] (0, 7.3)  rectangle (16, 8.5);  \node[draw] at (14.5, 0.7) {holiday};
    \draw[pink,   -,fill=pink   ] (0, 12)   rectangle (16, 13.4); \node[draw] at (14.5, 0.7) {entire history of USA};
