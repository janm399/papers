...
Consider two systems \circled{A} and \circled{B} that need to share parts of their state. Because the systems need to share [part of] their state, it is  \autoref{fig:2s-es} shows both systems as event-driven: 
