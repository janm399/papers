...
\newcommand{\pcode}[1]{
    \lstinline[basicstyle=\itshape, language=Pseudo, columns=fixed, escapechar=|, xrightmargin=0]{#1}
}
...
\lstdefinelanguage{Pseudo}
{
  morekeywords={
    ...
    typealias,struct,class,throws,enum,protocol,var,func,let,get,set,willSet,didSet,inout,init,deinit,extension,begin,end,not,and,or,xor,trait,val,null,sealed,object,extends,with,match,implicit,def,yield,new,
    subscript,prefix,operator,infix,postfix,precedence,associativity,left,right,none,convenience,dynamic,
